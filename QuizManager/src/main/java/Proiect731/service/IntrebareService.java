...
public class IntrebareService {
    ...
    public IntrebareRepo getIntrebareRepository() {
        return intrebareRepository;
    }

    public void setIntrebareRepository(IntrebareRepo intrebareRepository) {
        this.intrebareRepository = intrebareRepository;
    }

    public RaspunsRepo getRaspunsRepository() {
        return raspunsRepository;
    }

    public void setRaspunsRepository(RaspunsRepo raspunsRepository) {
        this.raspunsRepository = raspunsRepository;
    }

    public TraducereRaspunsRepo getTraducereRaspunsRepository() {
        return traducereRaspunsRepository;
    }

    public void setTraducereRaspunsRepository(TraducereRaspunsRepo traducereRaspunsRepository) {
        this.traducereRaspunsRepository = traducereRaspunsRepository;
    }

    public TraducereIntrebareRepo getTraducereIntrebareRepo() {
        return traducereIntrebareRepo;
    }

    public void setTraducereIntrebareRepo(TraducereIntrebareRepo traducereIntrebareRepo) {
        this.traducereIntrebareRepo = traducereIntrebareRepo;
    }

    public TraducereIntrebareService getServiceTradIntreb() {
        return serviceTradIntreb;
    }

    public void setServiceTradIntreb(TraducereIntrebareService serviceTradIntreb) {
        this.serviceTradIntreb = serviceTradIntreb;
    }

    public RaspunsService getRaspunsService() {
        return raspunsService;
    }
